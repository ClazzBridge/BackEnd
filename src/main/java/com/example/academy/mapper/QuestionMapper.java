...
public interface QuestionMapper {
    ...
    QuestionReadDTO questionToQuestionReadDTO(Question question, Member user);
    ...
    Question questionCreateDTOToQuestion(QuestionCreateDTO questionCreateDTO, Member user);
}
