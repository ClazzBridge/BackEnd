...
public class QuestionService {
    ...
    public QuestionReadDTO getQuestionById(Long id) {
        ...
        return questionMapper.questionToQuestionReadDTO(question, question.get());
    }

    public QuestionReadDTO createQuestion(QuestionCreateDTO questionCreateDTO) {
        Member user = userRepository.findById(questionCreateDTO.getUserId())
