...
-- course 테이블의 외래 키 삭제
ALTER TABLE course
    DROP FOREIGN KEY fk_instructor;
ALTER TABLE course
    DROP FOREIGN KEY fk_classroom;

-- seat 테이블의 외래 키 삭제
ALTER TABLE seat
    DROP FOREIGN KEY fk_classroom_seat;
ALTER TABLE seat
    DROP FOREIGN KEY fk_user_seat;
...
ALTER TABLE post
    DROP FOREIGN KEY fk_classroom_post;
ALTER TABLE post
...
ALTER TABLE question
    DROP FOREIGN KEY fk_member_id_question;

-- student_status 테이블의 외래 키 삭제
ALTER TABLE student_status
    DROP FOREIGN KEY fk_member_id_student_status;
...
drop table if exists communication restrict;
...
(
    ...
    board_type_id INT NOT NULL                    -- 게시판 유형 ID
);
...
ALTER TABLE submission
    ADD CONSTRAINT fk_assignment_submission
        FOREIGN KEY (assignment_id) REFERENCES assignment (id) ON DELETE NO ACTION,
    ADD CONSTRAINT fk_student_submission
        FOREIGN KEY (student_id) REFERENCES member (id) ON DELETE NO ACTION;

-- 게시판 테이블에 외래 키 추가
ALTER TABLE board
    ADD CONSTRAINT fk_board_type
        FOREIGN KEY (board_type_id) REFERENCES board_type (id) ON DELETE NO ACTION;

-- Post 테이블에 board_id, classroom_id, author_id에 대한 외래 키 추가
ALTER TABLE post
    ADD CONSTRAINT fk_board_post
        FOREIGN KEY (board_id) REFERENCES board (id) ON DELETE NO ACTION,
    ADD CONSTRAINT fk_classroom_post
        FOREIGN KEY (classroom_id) REFERENCES classroom (id) ON DELETE NO ACTION,
    ADD CONSTRAINT fk_author_post
        FOREIGN KEY (author_id) REFERENCES member (id) ON DELETE NO ACTION;
...
ALTER TABLE vote
    ADD CONSTRAINT fk_creator_vote
        FOREIGN KEY (creator_id) REFERENCES member (id) ON DELETE NO ACTION;
...
ALTER TABLE answer
    ...
    ADD CONSTRAINT fk_teacher_answer
        FOREIGN KEY (teacher_id) REFERENCES member (id) ON DELETE NO ACTION;

-- Question 테이블에 author_id에 대한 외래 키 추가
ALTER TABLE question
    ADD CONSTRAINT fk_member_id_question
        FOREIGN KEY (member_id) REFERENCES member (id) ON DELETE NO ACTION;

-- Question 테이블에 author_id에 대한 외래 키 추가
ALTER TABLE student_status
    ADD CONSTRAINT fk_member_id_student_status
