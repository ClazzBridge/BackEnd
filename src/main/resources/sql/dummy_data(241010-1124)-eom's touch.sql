...
VALUES ('자바 프로그래밍 기초', '자바 언어의 기초 문법과 객체 지향 프로그래밍을 배우는 강의입니다.', '2024-01-01', '2024-06-01', null, 2,
        1),
       ('파이썬 프로그래밍 입문', '초보자를 위한 파이썬 프로그래밍 기본 강의입니다.', '2024-01-01', '2024-06-01', null, 3, 2),
       ('웹 개발 실전', 'HTML, CSS, 자바스크립트를 활용한 웹사이트 구축 실습 강의입니다.', '2024-01-01', '2024-06-01', null, 2,
        1),
       ('데이터베이스 기초', 'SQL 문법과 MySQL을 활용한 데이터베이스 설계 및 관리 방법을 배웁니다.', '2024-01-01', '2024-06-01',
        null, 4,
        2),
       ('알고리즘과 자료구조', '알고리즘 문제 해결 능력을 향상시키기 위한 자료구조 강의입니다.', '2024-01-01', '2024-06-01', null, 5,
        1),
       ...
       ('머신러닝 입문', 'Python과 TensorFlow를 이용한 인공지능과 머신러닝 기초 강의입니다.', '2024-01-01', '2024-06-01', null,
        8,
        2),
       ('데이터 분석 기초', 'Python을 활용한 데이터 분석 및 시각화 실습 강의입니다.', '2024-01-01', '2024-06-01', null, 2, 1),
       ('소프트웨어 공학', '효율적인 소프트웨어 개발 방법론과 도구들을 배우는 강의입니다.', '2024-01-01', '2024-06-01', null, 9, 2);
...
INSERT INTO post (classroom_id, board_type_id, author_id, title, content, created_at)
...
INSERT INTO question (student_course_id, content, created_at, is_recommended, ai_answer,
                      teacher_answer, answered_at)
VALUES (1, '자바에서 오버로딩은 무엇을 의미하는지 설명해주세요.', '2024-01-10 10:00:00', FALSE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (2, '객체 지향 프로그래밍의 장점은 무엇이 있나요?', '2024-01-11 11:00:00', TRUE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (3, '파이썬에서 리스트와 튜플의 차이점은 무엇인가요?', '2024-01-12 12:00:00', FALSE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (4, '함수형 프로그래밍의 특징은 무엇이 있나요?', '2024-01-13 13:00:00', TRUE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (5, '객체 지향 프로그래밍에서 상속은 무엇을 의미하는지 설명해주세요.', '2024-01-14 14:00:00', FALSE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (1, '자바스크립트에서 콜백 함수는 무엇을 의미하는지 설명해주세요.', '2024-01-15 15:00:00', TRUE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (2, '함수 오버로딩과 함수 오버라이딩의 차이점은 무엇인가요?', '2024-01-16 16:00:00', TRUE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (3, '파이썬에서 데코레이터는 무엇을 의미하는지 설명해주세요.', '2024-01-17 17:00:00', FALSE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (4, '객체 지향 프로그래밍에서 캡슐화는 무엇을 의미하는지 설명해주세요.', '2024-01-18 18:00:00', TRUE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00'),
       (5, '자바에서 인터페이스는 무엇을 의미하는지 설명해주세요.', '2024-01-19 19:00:00', FALSE, 'ai 답변', 'ai 말이 맞음',
        '2024-01-12 12:00:00');

INSERT INTO schedule (classroom_id, event_title, start_date, end_date, description)
...
INSERT INTO seat (classroom_id, seat_number, is_exist, is_online, member_id)
...
VALUES (1, 1, 1), -- 학생 1이 교장 선거에서 Option A를 선택
       ...
       (3, 5, 5), -- 학생 5가 이벤트 날짜 결정에서 Option 1을 선택
       (3, 6, 6), -- 학생 6이 이벤트 날짜 결정에서 Option 2를 선택
